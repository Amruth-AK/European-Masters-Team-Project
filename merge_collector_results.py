...
Usage:
    ...
    python merge_collector_results.py --output_dir ./output_row --prefix row_features
"""
import argparse
import glob
import json
...
def merge_results(output_dir, prefix):
    ...
    # Remove duplicates — key depends on collector type
    ...
    # row collector: dataset_name + method is sufficient (one row per family per dataset)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--prefix', required=True,
                        help='CSV file prefix (numerical_transforms, categorical_transforms, interaction_features, row_features)')
