"""
collector_slurm.py — Unified SLURM Worker for All Three Collectors
===================================================================
...
Each SLURM array worker:
  ...
  3. Runs the specified collector (numerical, categorical, or interaction)
...
Merge all worker outputs afterwards:
  python merge_collector_results.py --output_dir ./output_numerical --collector numerical
"""
import argparse
import json
import os
...
# =============================================================================
# Force OpenML to use /work cache immediately
# =============================================================================
WORK_CACHE_DIR = '/work/inestp05/Final/openml_cache'
...
from collector_utils import write_csv
...
def main():
    ...
    parser.add_argument('--collector', type=str, required=True,
                        choices=['numerical', 'categorical', 'interaction'],
                        help='Which collector to run')
    parser.add_argument('--output_dir', type=str, default='./output',
                        help='Base output directory')
    parser.add_argument('--task_list', type=str, default='/work/inestp05/Final/task_list.json',
